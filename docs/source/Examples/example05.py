...
#     # Open file
#     ZemaxApp.OpenZemaxFile(
#         ZemaxApp.ExampleZemaxFilesLL() + os.sep + r"e02_SimpleRayTrace.zmx"
#     )
...
#     ZDR_dict = ZemaxApp.NCE_ReadZDRFile(
#         ZemaxApp.ExampleZemaxFilesLL() + os.sep + "e05_SimpleRayTrace.ZRD",
#         should_print=False,
#     )
#     del ZemaxApp
#     ZemaxApp = None
