...
#     # Open file
#     ZemaxApp.MakeNewZemaxFile(
#         ZemaxApp.ExampleZemaxFilesLL() + os.sep + r"e06_nsc_phase.zmx"
#     )
...
#     ZemaxApp.Visualization_NSC_ShadedModel(
#         save_image=True,
#         saved_image_location=ZemaxApp.ExampleZemaxFilesLL()
#         + os.sep
#         + r"e06_nsc_phase_Shaded.png",
#     )
...
#     mplot.subplot(2, 5, 4)
#     detector_xr.incoherent_radiance_position.swap_dims(
#         {"y_pixel": "y_distance", "x_pixel": "x_distance"}
#     ).plot.imshow()
#     mplot.subplot(2, 5, 5)
...
#     mplot.draw()
#     mplot.savefig(
#         ZemaxApp.ExampleZemaxFilesLL() + os.sep + r"e06_nsc_phase_Detector.png", dpi=600
#     )
