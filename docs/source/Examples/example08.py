...
#         ZemaxApp.SamplesDir()
#         + os.sep
#         + r"Non-sequential\Scattering\ABg scattering surface.zmx",
#         False,
#     )
...
#     ZemaxApp.NCE_ColocateObject(
#         in_objToChange=3, in_ReferenceObj=2, use_reference_flag=False
#     )
...
#     ZemaxApp.NCE_SaveDetectorInZemaxFormat(
#         3, ZemaxApp.DetectorFiles() + os.sep + "e08_NSCEDetectorDataPol"
#     )
#     ZemaxApp.NCE_SaveDetectorInZemaxFormat(
#         4, ZemaxApp.DetectorFiles() + os.sep + "e08_NSCEDetectorDataRect"
#     )
#     ZemaxApp.NCE_LoadDetectorInZemaxFormat(
#         3, ZemaxApp.DetectorFiles() + os.sep + "e08_NSCEDetectorDataPol"
#     )
#     ZemaxApp.NCE_LoadDetectorInZemaxFormat(
#         4, ZemaxApp.DetectorFiles() + os.sep + "e08_NSCEDetectorDataRect"
...
#     mplot.savefig(
#         ZemaxApp.ExampleZemaxFilesLL() + os.sep + r"e08_NSCEDetectorData_Detectors.png"
#     )

#     ZemaxApp.Visualization_NSC_3DViewer(
#         save_image=True,
#         saved_image_location=ZemaxApp.ExampleZemaxFilesLL()
#         + os.sep
#         + r"e08_NSCEDetectorData_3DView.png",
#     )
#     ZemaxApp.SaveZemaxFileAs(
#         ZemaxApp.ExampleZemaxFilesLL() + os.sep + r"e08_NSCEDetectorData.zmx"
#     )
